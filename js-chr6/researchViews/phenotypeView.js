...
*/
	...
	*/
	...
	//Get the library	
	$.getScript('/js/js-chr6/visualisation/chromoChart.js', function()
			...
			il_def.done(function(){
				ac_def.done(function(){
					dh_def.done(function(){
						...
						patientPositions = {};
						//get the arraydata
						$.get('/api/v2/chromosome6_array?q=Chromosoom==6').done(function(arrayData){
							//get the patients
...
/**This function creates a csv file from the given div with phenotypic information of patients in the phenotype view*/
	...
	//put the head elements in the csv file as first row (separated by ;)
