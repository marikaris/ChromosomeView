...
/**This function puts the functionality to plot qtl information (generated using R) in d3 in the head*/
	appendDocElementToHead('https://rawgit.com/kbroman/qtlcharts/master/inst/htmlwidgets/lib/d3-tip/index-min.js');
	$('head').append('<link href="https://rawgit.com/kbroman/qtlcharts/master/inst/htmlwidgets/lib/d3panels/d3panels.min.css" rel="stylesheet" />');
	appendDocElementToHead('https://rawgit.com/kbroman/qtlcharts/master/inst/htmlwidgets/lib/d3panels/d3panels.min.js');
	appendDocElementToHead('https://rawgit.com/kbroman/qtlcharts/master/inst/htmlwidgets/lib/qtlcharts/iplotScanone_noeff.js');
	appendDocElementToHead('https://rawgit.com/kbroman/qtlcharts/master/inst/htmlwidgets/lib/qtlcharts/iplotScanone_ci.js');
	appendDocElementToHead('https://rawgit.com/kbroman/qtlcharts/master/inst/htmlwidgets/lib/qtlcharts/iplotScanone_pxg.js');
};
...
then it puts the threshold in the plot*/
	$.get('/scripts/getThreshold/run?symptom='+symptom+'&alpha='+alpha).done(function(data){
    	...
    	$.getScript('https://rawgit.com/marikaris/20a9bfc82748f287cd07/raw/695792b6906c0ce86c36e58352d833ea668d1062/makeQtlGeneTable.js').done(function(){
